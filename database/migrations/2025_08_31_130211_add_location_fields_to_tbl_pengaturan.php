...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('tbl_pengaturan', function (Blueprint $table) {
            // menambahkan kolom lokasi & radius, setelah kolom existing 'backup_retention_days'
            $table->string('lokasi_sekolah_latitude', 30)->nullable()->after('backup_retention_days');
